<template>
    <div class="row-head-panel" ref="panel" @mousedown="mouseDownHandle" @mousemove="mouseMoveHandle">
        <row-head-item v-for="row in rowList" :key="row.alias" :row="row" :offsetTop="offsetTop">
        </row-head-item>
        <row-head-item class="adjust-row-head-item" v-if="adjustState" ref="adjustRowView" :offsetTop="offsetTop" :row="adjustRow">
        </row-head-item>
        <div class="temp-space-container" v-if="adjustState" ref="adjustPanelView">
            <row-head-item v-for="row in adjustRowList" :key="row.alias" :row="row" :offsetTop="offsetTop">
            </row-head-item>
        </div>
    </div>
</template>
