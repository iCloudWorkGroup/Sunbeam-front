                            ...
                            <tr>
                                ...
                                <td arrayposition="2">
                                    <a title="茶色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(238, 236, 225)"
                                             style="background-color: rgb(238, 236, 225);"></div>
                                    </a>
                                </td>
                                <td arrayposition="3">
                                    <a title="深蓝色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(31, 73, 125)"
                                             style="background-color: rgb(31, 73, 125);"></div>
                                    </a>
                                </td>
                                <td arrayposition="4">
                                    <a title="蓝色"
                                ...
                                <td arrayposition="5">
                                    <a title="红色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(192, 80, 77)"
                                             style="background-color: rgb(192, 80, 77);"></div>
                                    </a>
                                </td>
                                <td arrayposition="6">
                                    <a title="橄榄色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(155, 187, 89)"
                                             style="background-color: rgb(155, 187, 89);"></div>
                                    </a>
                                </td>
                                <td arrayposition="7">
                                    <a title="紫色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(128, 100, 162)"
                                             style="background-color: rgb(128, 100, 162);"></div>
                                    </a>
                                </td>
                                <td arrayposition="8">
                                    <a title="水绿色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(75, 172, 198)"
                                             style="background-color: rgb(75, 172, 198);"></div>
                                    </a>
                                </td>
                                <td arrayposition="9">
                                    <a title="橙色"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(247, 150, 70)"
                                             style="background-color: rgb(247, 150, 70);"></div>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td arrayposition="11">
                                    <a title="浅黑色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(127, 127, 127)"
                                             style="background-color: rgb(127, 127, 127);"></div>
                                    </a>
                                </td>
                                <td arrayposition="12">
                                    <a title="深茶色 10%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(221, 217, 195)"
                                             style="background-color: rgb(221, 217, 195);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="13">
                                    <a title="较浅的深蓝色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(198, 217, 240)"
                                             style="background-color: rgb(198, 217, 240);"></div>
                                    </a>
                                </td>
                                <td arrayposition="14">
                                    <a title="浅蓝色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(219, 229, 241)"
                                             style="background-color: rgb(219, 229, 241);"></div>
                                    </a>
                                </td>
                                <td arrayposition="15">
                                    <a title="浅红色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(242, 220, 219)"
                                             style="background-color: rgb(242, 220, 219);"></div>
                                    </a>
                                </td>
                                <td arrayposition="16">
                                    <a title="较浅的橄榄色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(235, 241, 221)"
                                             style="background-color: rgb(235, 241, 221);"></div>
                                    </a>
                                </td>
                                <td arrayposition="17">
                                    <a title="浅紫色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(229, 224, 236)"
                                             style="background-color: rgb(229, 224, 236);"></div>
                                    </a>
                                </td>
                                <td arrayposition="18">
                                    <a title="浅绿色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(219, 238, 243)"
                                             style="background-color: rgb(219, 238, 243);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="19">
                                    <a title="浅橙色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(253, 234, 218)"
                                             style="background-color: rgb(253, 234, 218);">
                                        </div>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td arrayposition="22">
                                    <a title="深茶色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(196, 189, 151)"
                                             style="background-color: rgb(196, 189, 151);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="23">
                                ...
                                <td arrayposition="25">
                                    <a title="浅红色 60%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(229, 185, 183)"
                                             style="background-color: rgb(229, 185, 183);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="26">
                                    <a title="较浅的橄榄色 60%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(215, 227, 188)"
                                             style="background-color: rgb(215, 227, 188);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="27">
                                    <a title="浅紫色 60%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(204, 193, 217)"
                                             style="background-color: rgb(204, 193, 217);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="28">
                                    <a title="浅绿色 80%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(183, 221, 232)"
                                             style="background-color: rgb(183, 221, 232);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="29">
                                    <a title="浅橙色 60%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(251, 213, 181)"
                                             style="background-color: rgb(251, 213, 181);">
                                        </div>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td arrayposition="32">
                                    <a title="深茶色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(147, 137, 83)"
                                             style="background-color: rgb(147, 137, 83);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="33">
                                ...
                                <td arrayposition="36">
                                    <a title="较浅的橄榄色 40%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(195, 214, 155)"
                                             style="background-color: rgb(195, 214, 155);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="37">
                                    <a title="浅紫色 40%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(178, 162, 199)"
                                             style="background-color: rgb(178, 162, 199);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="38">
                                    <a title="浅绿色 40%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(146, 205, 220)"
                                             style="background-color: rgb(146, 205, 220);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="39">
                                    <a title="浅橙色 40%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(250, 192, 143)"
                                             style="background-color: rgb(250, 192, 143);">
                                        </div>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td arrayposition="42">
                                    <a title="深茶色 75%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(73, 68, 41)"
                                             style="background-color: rgb(73, 68, 41);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="43">
                                    <a title="较浅的深蓝色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(23, 54, 93)"
                                             style="background-color: rgb(23, 54, 93);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="44">
                                    <a title="深黑色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(54, 96, 146)"
                                             style="background-color: rgb(54, 96, 146);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="45">
                                    <a title="深红色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(149, 55, 52)"
                                             style="background-color: rgb(149, 55, 52);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="46">
                                    <a title="较深的橄榄色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(118, 146, 60)"
                                             style="background-color: rgb(118, 146, 60);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="47">
                                    <a title="深紫色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(95, 73, 122)"
                                             style="background-color: rgb(95, 73, 122);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="48">
                                    <a title="暗绿色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(49, 132, 155)"
                                             style="background-color: rgb(49, 132, 155);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="49">
                                    <a title="深橙色 25%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(227, 108, 9)"
                                             style="background-color: rgb(227, 108, 9);">
                                        </div>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td arrayposition="52">
                                    <a title="深茶色 90%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(29, 27, 16)"
                                             style="background-color: rgb(29, 27, 16);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="53">
                                    <a title="较浅的深蓝色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(15, 36, 62)"
                                             style="background-color: rgb(15, 36, 62);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="54">
                                    <a title="深黑色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(36, 64, 97)"
                                             style="background-color: rgb(36, 64, 97);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="55">
                                    <a title="深红色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(99, 36, 35)"
                                             style="background-color: rgb(99, 36, 35);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="56">
                                    <a title="较深的橄榄色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(79, 97, 40)"
                                             style="background-color: rgb(79, 97, 40);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="57">
                                    <a title="深紫色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(63, 49, 81)"
                                             style="background-color: rgb(63, 49, 81);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="58">
                                    <a title="暗绿色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(32, 88, 103)"
                                             style="background-color: rgb(32, 88, 103);">
                                        </div>
                                    </a>
                                </td>
                                <td arrayposition="59">
                                    <a title="深橙色 50%"
                                       class="color-box">
                                        <div class="color-body"
                                             data-value="rgb(152, 72, 6)"
                                             style="background-color: rgb(152, 72, 6);">
                                        </div>
                                    </a>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td arrayposition="6">
                                        <a title="浅蓝色"
                                           class="color-box">
                                            <div class="color-body"
                                                 data-value="rgb(0, 176, 240)"
                                                 style="background-color: rgb(0, 176, 240);">
                                            </div>
                                        </a>
                                    </td>
                                    <td arrayposition="7">
                                    ...
                                    <td arrayposition="8">
                                        <a title="深蓝色"
                                           class="color-box">
                                            <div class="color-body"
                                                 data-value="rgb(0, 32, 96)"
                                                 style="background-color: rgb(0, 32, 96);">
                                            </div>
                                        </a>
                                    </td>
                                    <td arrayposition="9">
                                        <a title="紫色"
                                           class="color-box">
                                            <div class="color-body"
                                                 data-value="rgb(112, 48, 160)"
                                                 style="background-color: rgb(112, 48, 160);">
                                            </div>
                                        </a>
                                    </td>
                                </tr>
