...
export default function(store) {
    ...
    store.subscribeBeforeAction((action, state) => {
        ...
        if (recordAction[type]) {
            ...
            // 解冻需要记录原冻结状态
            if (type === actionTypes.SHEET_EXECUNFROZEN) {
        ...
        if (Object.prototype.hasOwnProperty.call(props, name)) {
            ...
            if (isObject(value)) {
                if (Array.isArray(value) && Array.isArray(src)) {
                    ...
                    if (typeof src === 'undefined' && typeof defaultValue !== 'undefined') {
                        result[name] = getDiffValue(defaultValue[name], value, defaultValue[name])
                    } else if (typeof src !== 'undefined' && typeof defaultValue !== 'undefined') {
                        result[name] = getDiffValue(src, value, defaultValue[name])
                    } else if (typeof src !== 'undefined' && typeof defaultValue === 'undefined') {
